...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/reportes/doctors/colum', [App\Http\Controllers\admin\ChartController::class, 'doctors']);

    Route::get('/reportes/doctors/colum/data', [App\Http\Controllers\admin\ChartController::class, 'doctorsJson']);
});
