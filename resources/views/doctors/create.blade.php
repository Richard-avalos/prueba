    ...
    <div class="card-body"> 
        ...
        <form action="{{ url('/medicos') }}" method="POST">
            ...
            <div class="form-group">
                ...
                data-style="btn-primary" title="Seleccionar especialidades" multiple require>
            ...
            <div class"form-group">
                ...
                <input type="text" name="address" class="form-control" value=" {{ old('addres') }}">
            </div>
            <div class"form-group">
            ...
            <button type="sumit" class="btn btn-sm btn-primary">Crear medico</button>
        </form>
    </div>
