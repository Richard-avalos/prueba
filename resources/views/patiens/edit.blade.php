    ...
    <div class="card-body"> 
        ...
        <form action="{{ url('/pacientes/'.$patient->id) }}" method="POST">
            ...
            <div class"form-group">
                ...
                <small class="text-warining">Solo llena el campo si desea cambiar la contraseña.</small>
            </div>
            <button type="sumit" class="btn btn-sm btn-primary">Guardar cambios</button>
        </form>
    </div>
